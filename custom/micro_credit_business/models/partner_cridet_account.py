...
class PartnerCreditAccount(models.Model):
    ...
    last_disbursed_amount = fields.Float(related='last_disbust_id.amount_disbust')
    last_disbursed_paid = fields.Float(compute='get_last_disbursed_info')
    last_disbursed_remain = fields.Float(compute='get_last_disbursed_info')
    ...
    def _get_total_amount(self):
        for rec in self:
            rec.total_payed = sum(rec.loan_ids.mapped('amount_disbust')) or 0.0
